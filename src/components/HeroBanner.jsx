    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="space-y-4">
          <Card className="bg-gradient-to-r from-orange-500 to-red-500 text-white p-4 h-32">
            <h3 className="font-semibold mb-1">Flash Sale</h3>
            <p className="text-sm opacity-90">Limited time offers</p>
          </Card>
          <Card className="bg-gradient-to-r from-indigo-500 to-blue-500 text-white p-4 h-32">
